  $(document).ready(function(){
    ...
    if (localStorage.getItem('userdetails') === null) {  
        ...
        var userDetails = {firstName:"Megan", lastName:"Little", dob:"2001-05-08",address1:"Ballysumaghan", address2:"Sooey", address3:"Sligo"};
    ...
    $('form[name="login"]' ).submit(function( event ) {
        ...
        if (email=="megan@gmail.com" && password=="password1")  {   
